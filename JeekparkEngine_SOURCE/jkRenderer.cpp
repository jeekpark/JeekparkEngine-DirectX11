...
namespace jk::renderer
{
	...
	static void LoadTriangleMesh()
	{
		...
		jk::Resources::Insert(L"TriangleMesh", mesh);
	}

	static void LoadRectMesh()
	{
		Mesh* mesh = new Mesh();
		...
		jk::Resources::Insert(L"RectMesh", mesh);
	}
	...
	static void LoadShaders()
	{
		...
		jk::Resources::Load<graphics::Shader>(L"Sprite-Default-Shader", L"..\\Shaders_SOURCE\\Sprite-Default");

	}

	static void LoadMeterails()
	{
		Material* triangleMaterial = new Material();
		triangleMaterial->SetShader(jk::Resources::Find<graphics::Shader>(L"TriangleShader"));
		jk::Resources::Insert(L"TriangleMaterial", triangleMaterial);
		...
		spriteMaterial->SetShader(jk::Resources::Find<graphics::Shader>(L"Sprite-Default-Shader"));
		jk::Resources::Insert(L"Sprite-Default-Material", spriteMaterial);
	}

	static void LoadConstantBuffers()
	{
