...
namespace jk::renderer
{
	...
	static void LoadShaders()
	{
		...
		jk::Resources::Load<graphics::Shader>(L"SpriteShader", L"..\\Shaders_SOURCE\\Sprite");
	...
	static void LoadMeterails()
	{
		...
		spriteMaterial->SetShader(jk::Resources::Find<graphics::Shader>(L"SpriteShader"));
		jk::Resources::Insert(L"SpriteMaterial", spriteMaterial);
	}
